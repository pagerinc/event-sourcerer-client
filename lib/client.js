...
class Client {
    ...
    constructor(transport, idGenerator = Uuid) {
        ...
        this.validationOptionsMap = new Map();
    }
    ...
    addPrePublishValidator(stream, eventType, schema, options = { }) {
        ...
        this.validationOptionsMap.set(streamAndEventType, options);
    }
    ...
    validate(stream, eventType, data) {
        ...
        const options = this.validationOptionsMap.get(streamAndEventType);
